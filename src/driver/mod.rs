...
impl Device {
    ...
    pub fn max_threads_per_block(&self) -> Result<i32> {
        self.get(self::ll::CUdevice_attribute_enum::CU_DEVICE_ATTRIBUTE_MAX_THREADS_PER_BLOCK)
    }

    /// Returns maximum x-dimension of a block
    pub fn max_block_dim_x(&self) -> Result<i32> {
        self.get(self::ll::CUdevice_attribute_enum::CU_DEVICE_ATTRIBUTE_MAX_BLOCK_DIM_X)
    }

    /// Returns maximum y-dimension of a block
    pub fn max_block_dim_y(&self) -> Result<i32> {
        self.get(self::ll::CUdevice_attribute_enum::CU_DEVICE_ATTRIBUTE_MAX_BLOCK_DIM_Y)
    }

    /// Returns maximum z-dimension of a block
    pub fn max_block_dim_z(&self) -> Result<i32> {
        self.get(self::ll::CUdevice_attribute_enum::CU_DEVICE_ATTRIBUTE_MAX_BLOCK_DIM_Z)
    }

    /// Returns maximum x-dimension of a grid
    pub fn max_grid_dim_x(&self) -> Result<i32> {
        self.get(self::ll::CUdevice_attribute_enum::CU_DEVICE_ATTRIBUTE_MAX_GRID_DIM_X)
    }

    /// Returns maximum y-dimension of a grid
    pub fn max_grid_dim_y(&self) -> Result<i32> {
        self.get(self::ll::CUdevice_attribute_enum::CU_DEVICE_ATTRIBUTE_MAX_GRID_DIM_Y)
    }

    /// Returns maximum z-dimension of a grid
    pub fn max_grid_dim_z(&self) -> Result<i32> {
        self.get(self::ll::CUdevice_attribute_enum::CU_DEVICE_ATTRIBUTE_MAX_GRID_DIM_Z)
    }
    ...
    pub fn max_shared_memory_per_block(&self) -> Result<i32> {
        self.get(self::ll::CUdevice_attribute_enum::CU_DEVICE_ATTRIBUTE_MAX_SHARED_MEMORY_PER_BLOCK)
    }
    ...
    pub fn total_constant_memory(&self) -> Result<i32> {
        self.get(self::ll::CUdevice_attribute_enum::CU_DEVICE_ATTRIBUTE_TOTAL_CONSTANT_MEMORY)
    }

    /// Returns warp size in threads
    pub fn warp_size(&self) -> Result<i32> {
        self.get(self::ll::CUdevice_attribute_enum::CU_DEVICE_ATTRIBUTE_WARP_SIZE)
    }
    ...
    pub fn max_pitch(&self) -> Result<i32> {
        self.get(self::ll::CUdevice_attribute_enum::CU_DEVICE_ATTRIBUTE_MAX_PITCH)
    }

    /// Returns maximum 1D texture width
    pub fn maximum_texture1d_width(&self) -> Result<i32> {
        self.get(self::ll::CUdevice_attribute_enum::CU_DEVICE_ATTRIBUTE_MAXIMUM_TEXTURE1D_WIDTH)
    }

    /// Returns maximum width for a 1D texture bound to linear memory
    pub fn maximum_texture1d_linear_width(&self) -> Result<i32> {
        self.get(self::ll::CUdevice_attribute_enum::CU_DEVICE_ATTRIBUTE_MAXIMUM_TEXTURE1D_LINEAR_WIDTH)
    }

    /// Returns maximum mipmapped 1D texture width
    pub fn maximum_texture1d_mipmapped_width(&self) -> Result<i32> {
        self.get(self::ll::CUdevice_attribute_enum::CU_DEVICE_ATTRIBUTE_MAXIMUM_TEXTURE1D_MIPMAPPED_WIDTH)
    }

    /// Returns maximum 2D texture width
    pub fn maximum_texture2d_width(&self) -> Result<i32> {
        self.get(self::ll::CUdevice_attribute_enum::CU_DEVICE_ATTRIBUTE_MAXIMUM_TEXTURE2D_WIDTH)
    }

    /// Returns maximum 2D texture height
    pub fn maximum_texture2d_height(&self) -> Result<i32> {
        self.get(self::ll::CUdevice_attribute_enum::CU_DEVICE_ATTRIBUTE_MAXIMUM_TEXTURE2D_HEIGHT)
    }

    /// Returns maximum width for a 2D texture bound to linear memory
    pub fn maximum_texture2d_linear_width(&self) -> Result<i32> {
        self.get(self::ll::CUdevice_attribute_enum::CU_DEVICE_ATTRIBUTE_MAXIMUM_TEXTURE2D_LINEAR_WIDTH)
    }

    /// Returns maximum height for a 2D texture bound to linear memory
    pub fn maximum_texture2d_linear_height(&self) -> Result<i32> {
        self.get(self::ll::CUdevice_attribute_enum::CU_DEVICE_ATTRIBUTE_MAXIMUM_TEXTURE2D_LINEAR_HEIGHT)
    }
    ...
    pub fn maximum_texture2d_linear_pitch(&self) -> Result<i32> {
        self.get(self::ll::CUdevice_attribute_enum::CU_DEVICE_ATTRIBUTE_MAXIMUM_TEXTURE2D_LINEAR_PITCH)
    }

    /// Returns maximum mipmapped 2D texture width
    pub fn maximum_texture2d_mipmapped_width(&self) -> Result<i32> {
        self.get(self::ll::CUdevice_attribute_enum::CU_DEVICE_ATTRIBUTE_MAXIMUM_TEXTURE2D_MIPMAPPED_WIDTH)
    }

    /// Returns maximum mipmapped 2D texture height
    pub fn maximum_texture2d_mipmapped_height(&self) -> Result<i32> {
        self.get(self::ll::CUdevice_attribute_enum::CU_DEVICE_ATTRIBUTE_MAXIMUM_TEXTURE2D_MIPMAPPED_HEIGHT)
    }

    /// Returns maximum 3D texture width
    pub fn maximum_texture3d_width(&self) -> Result<i32> {
        self.get(self::ll::CUdevice_attribute_enum::CU_DEVICE_ATTRIBUTE_MAXIMUM_TEXTURE3D_WIDTH)
    }

    /// Returns maximum 3D texture height
    pub fn maximum_texture3d_height(&self) -> Result<i32> {
        self.get(self::ll::CUdevice_attribute_enum::CU_DEVICE_ATTRIBUTE_MAXIMUM_TEXTURE3D_HEIGHT)
    }

    /// Returns maximum 3D texture depth
    pub fn maximum_texture3d_depth(&self) -> Result<i32> {
        self.get(self::ll::CUdevice_attribute_enum::CU_DEVICE_ATTRIBUTE_MAXIMUM_TEXTURE3D_DEPTH)
    }
    ...
    pub fn maximum_texture3d_width_alternate(&self) -> Result<i32> {
        self.get(self::ll::CUdevice_attribute_enum::CU_DEVICE_ATTRIBUTE_MAXIMUM_TEXTURE3D_WIDTH_ALTERNATE)
    }
    ...
    pub fn maximum_texture3d_height_alternate(&self) -> Result<i32> {
        self.get(self::ll::CUdevice_attribute_enum::CU_DEVICE_ATTRIBUTE_MAXIMUM_TEXTURE3D_HEIGHT_ALTERNATE)
    }
    ...
    pub fn texture_alignment(&self) -> Result<i32> {
        self.get(self::ll::CUdevice_attribute_enum::CU_DEVICE_ATTRIBUTE_TEXTURE_ALIGNMENT)
    }
    ...
    pub fn texture_pitch_alignment(&self) -> Result<i32> {
        self.get(self::ll::CUdevice_attribute_enum::CU_DEVICE_ATTRIBUTE_TEXTURE_PITCH_ALIGNMENT)
    }
    ...
    pub fn gpu_overlap(&self) -> Result<bool> {
        self.get(self::ll::CUdevice_attribute_enum::CU_DEVICE_ATTRIBUTE_GPU_OVERLAP).map(|f| f != 0)
    }

    /// Returns number of multiprocessors on the device
    pub fn multiprocessor_count(&self) -> Result<i32> {
        self.get(self::ll::CUdevice_attribute_enum::CU_DEVICE_ATTRIBUTE_MULTIPROCESSOR_COUNT)
    }
    ...
    pub fn kernel_exec_timeout(&self) -> Result<bool> {
        self.get(self::ll::CUdevice_attribute_enum::CU_DEVICE_ATTRIBUTE_KERNEL_EXEC_TIMEOUT).map(|f| f != 0)
    }

    /// Returns true if the device is integrated with the memory subsystem, or false if not
    pub fn integrated(&self) -> Result<bool> {
        self.get(self::ll::CUdevice_attribute_enum::CU_DEVICE_ATTRIBUTE_INTEGRATED).map(|f| f != 0)
    }
    ...
    pub fn can_map_host_memory(&self) -> Result<bool> {
        self.get(self::ll::CUdevice_attribute_enum::CU_DEVICE_ATTRIBUTE_CAN_MAP_HOST_MEMORY).map(|f| f != 0)
    }

    /// Returns compute mode that device is currently in
    pub fn compute_mode(&self) -> Result<ComputeMode> {
        self.get(self::ll::CUdevice_attribute_enum::CU_DEVICE_ATTRIBUTE_COMPUTE_MODE).map(|mode| match mode {
            mode if mode == self::ll::CUcomputemode_enum::CU_COMPUTEMODE_DEFAULT as i32 => ComputeMode::Default,
            mode if mode == self::ll::CUcomputemode_enum::CU_COMPUTEMODE_PROHIBITED as i32 => ComputeMode::Prohibited,
            mode if mode == self::ll::CUcomputemode_enum::CU_COMPUTEMODE_EXCLUSIVE_PROCESS as i32 => ComputeMode::ExclusiveProcess,
    ...
    pub fn concurrent_kernels(&self) -> Result<bool> {
        self.get(self::ll::CUdevice_attribute_enum::CU_DEVICE_ATTRIBUTE_CONCURRENT_KERNELS).map(|f| f != 0)
    }
    ...
    pub fn ecc_enabled(&self) -> Result<bool> {
        self.get(self::ll::CUdevice_attribute_enum::CU_DEVICE_ATTRIBUTE_ECC_ENABLED).map(|f| f != 0)
    }

    /// Returns pCI bus identifier of the device
    pub fn pci_bus_id(&self) -> Result<i32> {
        self.get(self::ll::CUdevice_attribute_enum::CU_DEVICE_ATTRIBUTE_PCI_BUS_ID)
    }

    /// Returns pCI device (also known as slot) identifier of the device
    pub fn pci_device_id(&self) -> Result<i32> {
        self.get(self::ll::CUdevice_attribute_enum::CU_DEVICE_ATTRIBUTE_PCI_DEVICE_ID)
    }
    ...
    pub fn tcc_driver(&self) -> Result<bool> {
        self.get(self::ll::CUdevice_attribute_enum::CU_DEVICE_ATTRIBUTE_TCC_DRIVER).map(|f| f != 0)
    }

    /// Returns peak memory clock frequency in kilohertz
    pub fn memory_clock_rate(&self) -> Result<i32> {
        self.get(self::ll::CUdevice_attribute_enum::CU_DEVICE_ATTRIBUTE_MEMORY_CLOCK_RATE)
    }

    /// Returns global memory bus width in bits
    pub fn global_memory_bus_width(&self) -> Result<i32> {
        self.get(self::ll::CUdevice_attribute_enum::CU_DEVICE_ATTRIBUTE_GLOBAL_MEMORY_BUS_WIDTH)
    }

    /// Returns size of L2 cache in bytes. 0 if the device doesn't have L2 cache
    pub fn l2_cache_size(&self) -> Result<i32> {
        self.get(self::ll::CUdevice_attribute_enum::CU_DEVICE_ATTRIBUTE_L2_CACHE_SIZE)
    }

    /// Returns maximum resident threads per multiprocessor;\
    pub fn max_threads_per_multiprocessor(&self) -> Result<i32> {
        self.get(self::ll::CUdevice_attribute_enum::CU_DEVICE_ATTRIBUTE_MAX_THREADS_PER_MULTIPROCESSOR)
    }
    ...
    pub fn unified_addressing(&self) -> Result<bool> {
        self.get(self::ll::CUdevice_attribute_enum::CU_DEVICE_ATTRIBUTE_UNIFIED_ADDRESSING).map(|f| f != 0)
    }

    /// Returns major compute capability version number
    pub fn compute_capability_major(&self) -> Result<i32> {
        self.get(self::ll::CUdevice_attribute_enum::CU_DEVICE_ATTRIBUTE_COMPUTE_CAPABILITY_MAJOR)
    }

    /// Returns minor compute capability version number
    pub fn compute_capability_minor(&self) -> Result<i32> {
        self.get(self::ll::CUdevice_attribute_enum::CU_DEVICE_ATTRIBUTE_COMPUTE_CAPABILITY_MINOR)
    }
    ...
    pub fn global_l1_cache_supported(&self) -> Result<bool> {
        self.get(self::ll::CUdevice_attribute_enum::CU_DEVICE_ATTRIBUTE_GLOBAL_L1_CACHE_SUPPORTED).map(|f| f != 0)
    }
    ...
    pub fn local_l1_cache_supported(&self) -> Result<bool> {
        self.get(self::ll::CUdevice_attribute_enum::CU_DEVICE_ATTRIBUTE_LOCAL_L1_CACHE_SUPPORTED).map(|f| f != 0)
    }
    ...
    pub fn max_shared_memory_per_multiprocessor(&self) -> Result<i32> {
        self.get(self::ll::CUdevice_attribute_enum::CU_DEVICE_ATTRIBUTE_MAX_SHARED_MEMORY_PER_MULTIPROCESSOR)
    }
    ...
    pub fn max_registers_per_multiprocessor(&self) -> Result<i32> {
        self.get(self::ll::CUdevice_attribute_enum::CU_DEVICE_ATTRIBUTE_MAX_REGISTERS_PER_MULTIPROCESSOR)
    }
    ...
    pub fn managed_memory(&self) -> Result<bool> {
        self.get(self::ll::CUdevice_attribute_enum::CU_DEVICE_ATTRIBUTE_MANAGED_MEMORY).map(|f| f != 0)
    }

    /// Returns true if device is on a multi-GPU board, false if not
    pub fn multi_gpu_board(&self) -> Result<bool> {
        self.get(self::ll::CUdevice_attribute_enum::CU_DEVICE_ATTRIBUTE_MULTI_GPU_BOARD).map(|f| f != 0)
    }
    ...
    pub fn multi_gpu_board_group_id(&self) -> Result<i32> {
        self.get(self::ll::CUdevice_attribute_enum::CU_DEVICE_ATTRIBUTE_MULTI_GPU_BOARD_GROUP_ID)
    }
    ...
    pub fn host_native_atomic_supported(&self) -> Result<bool> {
        self.get(self::ll::CUdevice_attribute_enum::CU_DEVICE_ATTRIBUTE_HOST_NATIVE_ATOMIC_SUPPORTED).map(|f| f != 0)
    }
    ...
    pub fn single_to_double_precision_perf_ratio(&self) -> Result<i32> {
        self.get(self::ll::CUdevice_attribute_enum::CU_DEVICE_ATTRIBUTE_SINGLE_TO_DOUBLE_PRECISION_PERF_RATIO)
    }
    ...
    pub fn pageable_memory_access(&self) -> Result<i32> {
        self.get(self::ll::CUdevice_attribute_enum::CU_DEVICE_ATTRIBUTE_PAGEABLE_MEMORY_ACCESS)
    }
    ...
    pub fn concurrent_managed_access(&self) -> Result<bool> {
        self.get(self::ll::CUdevice_attribute_enum::CU_DEVICE_ATTRIBUTE_CONCURRENT_MANAGED_ACCESS).map(|f| f != 0)
    }

    /// Returns true if device supports Compute Preemption, false if not
    pub fn compute_preemption_supported(&self) -> Result<bool> {
        self.get(self::ll::CUdevice_attribute_enum::CU_DEVICE_ATTRIBUTE_COMPUTE_PREEMPTION_SUPPORTED).map(|f| f != 0)
    }
    ...
    pub fn can_use_host_pointer_for_registered_mem(&self) -> Result<bool> {
        self.get(self::ll::CUdevice_attribute_enum::CU_DEVICE_ATTRIBUTE_CAN_USE_HOST_POINTER_FOR_REGISTERED_MEM).map(|f| f != 0)
    }
...
impl<'ctx, 'm> Function<'ctx, 'm> {
    ...
    ///   currently loaded.
    pub fn max_threads_per_block(&self) -> Result<i32> {
        self.get(self::ll::CUfunction_attribute_enum::CU_FUNC_ATTRIBUTE_MAX_THREADS_PER_BLOCK)
    }
    ...
    pub fn shared_size_bytes(&self) -> Result<i32> {
        self.get(self::ll::CUfunction_attribute_enum::CU_FUNC_ATTRIBUTE_SHARED_SIZE_BYTES)
    }

    /// Returns the size in bytes of user-allocated
    ///   constant memory required by this function.
    pub fn const_size_bytes(&self) -> Result<i32> {
        self.get(self::ll::CUfunction_attribute_enum::CU_FUNC_ATTRIBUTE_CONST_SIZE_BYTES)
    }

    /// Returns the size in bytes of local memory
    ///   used by each thread of this function.
    pub fn local_size_bytes(&self) -> Result<i32> {
        self.get(self::ll::CUfunction_attribute_enum::CU_FUNC_ATTRIBUTE_LOCAL_SIZE_BYTES)
    }

    /// Returns the number of registers used by each thread
    ///   of this function.
    pub fn num_regs(&self) -> Result<i32> {
        self.get(self::ll::CUfunction_attribute_enum::CU_FUNC_ATTRIBUTE_NUM_REGS)
    }
    ...
    pub fn ptx_version(&self) -> Result<i32> {
        self.get(self::ll::CUfunction_attribute_enum::CU_FUNC_ATTRIBUTE_PTX_VERSION)
    }
    ...
    pub fn binary_version(&self) -> Result<i32> {
        self.get(self::ll::CUfunction_attribute_enum::CU_FUNC_ATTRIBUTE_BINARY_VERSION)
    }

    /// Returns the attribute to indicate whether the function has
    ///   been compiled with user specified option "-Xptxas --dlcm=ca" set.
    pub fn cache_mode_ca(&self) -> Result<bool> {
        self.get(self::ll::CUfunction_attribute_enum::CU_FUNC_ATTRIBUTE_CACHE_MODE_CA).map(|f| f != 0)
    }
